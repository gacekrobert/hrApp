    ...
    public partial class manageholiday : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                {
                    Response.Redirect("manageholidays.aspx");
                }
            }
        ...
        protected void goBack_Click(object sender, EventArgs e)
        {
                ...
                string url_text = "manageholidays.aspx";
        ...
        protected void rejectHR_Click(object sender, EventArgs e)
        {
            ...
            string url_text = "manageholiday.aspx?holidayid=" + this.l_id.Text;
            Response.Redirect(url_text);
        ...
        {
            holiday h = PolaczenieSQL.find_holiday(this.l_id.Text);
            h.deletedHR(Context.User.Identity.Name);
            string url_text = "manageholiday.aspx?holidayid=" + this.l_id.Text;
            Response.Redirect(url_text);
